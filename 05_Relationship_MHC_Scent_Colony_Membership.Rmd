...
```{r}
## Mantel test
vegan::mantel(ydis = ufrac, xdis = 1 - as.dist(microsats_sub), method = "spearman", permutation = 9999)

x <- vegan::mantel.correlog(D.geo = ufrac, D.eco =  1 - as.dist(microsats_sub), n.class = 4, r.type = "spearman")
plot(x)
